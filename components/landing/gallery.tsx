...
const SOCIALS = [
    {
        name: "Instagram",
        url: "https://www.instagram.com/salopem_",
    ...
    return (
        <div className="flex flex-col items-center gap-8 my-12">
            ...
            <div className="flex justify-center gap-8 flex-wrap">
              ...
              relative rounded-3xl shadow-2xl p-1
              w-[220px] h-[420px] md:w-[320px] md:h-[620px]
            ...
            `}
                    ...
                    >
                        ...
                        <div className="absolute top-3 left-1/2 -translate-x-1/2 w-20 h-3 bg-gray-200 rounded-lg" />
                        {/* Pantalla */}
                        <div className="w-[90%] h-[90%] bg-white rounded-2xl overflow-hidden shadow-inner flex items-center justify-center mt-8 mb-4 relative z-20">
                        ...
                        {/* Botón Home */}
                        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 w-14 h-2 bg-gray-300 rounded-full z-20" />
                    </motion.a>
                ))}
            </div>
        </div>
