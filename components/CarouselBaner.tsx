            ...
            >
              ...
              <div className={`${current.textColor} z-10 ${isMobile ? "max-w-sm mx-auto" : "space-y-6"}`}>
                ...
                >
                  ...
                  <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#ab45ffff]">{current.price}</div>
                </motion.div>
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      className="bg-purple-600 text-white hover:bg-purple-500  px-4 sm:px-6 lg:px-8 shadow-lg text-sm lg:text-base"
                    >
                      <motion.div
