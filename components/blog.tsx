    ...
    return (
        <div className="container mx-auto px-4 py-8">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="absolute top-4 right-4 z-10">
                                <Badge className={`${card.categoryColor} text-white border-0 px-3 py-1 text-sm font-medium rounded-full`}>
                                    {card.category}
                                </Badge>
                            </div>
            ...
            <div className="flex justify-center mt-10">
                <button
                    className="px-8 py-3 bg-teal-500 text-white font-semibold rounded-full shadow hover:bg-[#b3a6e6] transition-colors text-lg"
                >
                    Ver más
                </button>
            </div>
