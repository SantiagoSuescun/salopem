...
export default function ProductDetail() {
  ...
  const relatedProducts = cosmeticProducts
    .filter((p) => {
      ...
      return p.id !== product.id && pCategories.some((cat) => productCategories.includes(cat))
    })
    .slice(0, 3)
        ...
        <div className="grid lg:grid-cols-2 gap-5 lg:gap-8 p-6 md:p-10">
          ...
          <div className="space-y-8">
            ...
            <div className="text-gray-700 text-base mb-4">
              ...
              {/* Features Icons */}
              <div className="flex gap-8 md:gap-12 mb-6 justify-center md:justify-start flex-wrap">
                  ...
                  <CardContent className="p-0">
                    <div className="relative">
                      ...
                      {relatedProduct.discount && (
                        <Badge className="absolute top-1 left-1 bg-red-500 text-white px-1 py-0.5 rounded-full text-xs font-semibold">
                          -{relatedProduct.discount}%
                        </Badge>
                      )}
                    </div>
